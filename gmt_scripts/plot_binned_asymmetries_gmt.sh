#!/bin/bash
gmt makecpt -Cpolar -T-0.1/0.1/0.0125 -Z -Di > gmt_scripts/temp/t.cpt
...
#gmt psxy ./gmt_scripts/temp/asym_stas.txt -R$region -J$proj -K -O -B$gridding -Gred -St0.1i >> testmap.ps
